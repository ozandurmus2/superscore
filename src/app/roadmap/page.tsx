...
const PHASES: Phase[] = [
  {
    ...
    tasks: [
      ...
      { label: 'Environment & deployment yapılandırması (Vercel)', status: 'done' },
    ],
  },
  {
    id: 'p2',
    ...
    tasks: [
      ...
      { label: 'Yardım Merkezi (Help Center)', status: 'in-progress', detail: 'SSS, rehberler, destek sistemi' },
  ...
  },
  {
    ...
    tasks: [
      ...
      { label: 'Moderatör paneli (çalışan girişi, üyelik yönetimi)', status: 'in-progress', detail: 'Şikayetler, markalar, paketler, özellikler' },
      { label: 'Paket yönetimi (abonelik planları CRUD)', status: 'planned', detail: 'Paket bazında özellik ekleme/çıkarma, B2B yansıması' },
      { label: 'Marka detay yönetimi (paket, özellik, durum)', status: 'planned' },
  ...
  },
  {
    ...
    tasks: [
      ...
      { label: 'Stripe / iyzico ödeme entegrasyonu', status: 'in-progress', detail: 'B2B paket satın alma sistemi' },
      { label: 'White-label widget embed sistemi', status: 'in-progress', detail: 'İkasta/Tsoft için widget kodları' },
