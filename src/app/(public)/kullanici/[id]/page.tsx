                    ...
                    <div key={review.id as string}>
                      ...
                      <div className="bg-white rounded-2xl border border-gray-200 overflow-hidden">
                        ...
                        <div className="px-5 py-4 flex items-center gap-3">
                          ...
                          <div>
                            <Link href={`/kullanici/${id}`} className="font-semibold text-sm text-[#1b1a1b] hover:underline">{String(user.full_name || '')}</Link>
              ...
              {totalPages > 1 && (
                <div className="mt-8 flex justify-center">
                  <div className="inline-flex items-center border border-gray-200 rounded-xl overflow-hidden bg-white">
                    {currentPage > 1 ? (
                      <Link href={`/kullanici/${id}?page=${currentPage - 1}`} className="px-4 py-3 text-sm text-gray-500 hover:bg-gray-50 border-r border-gray-200 flex items-center gap-1">
                    ...
                    {Array.from({ length: Math.min(totalPages, 5) }).map((_, i) => {
                      ...
                      return (
                        <Link
                          key={pageNum}
                          href={`/kullanici/${id}?page=${pageNum}`}
                    ...
                    {currentPage < totalPages ? (
                      <Link href={`/kullanici/${id}?page=${currentPage + 1}`} className="px-4 py-3 text-sm text-gray-500 hover:bg-gray-50 flex items-center gap-1">
