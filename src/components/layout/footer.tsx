  ...
  return (
    <footer className="relative">
      ...
      <div className="bg-white">
        <div className="h-10 md:h-14 bg-[#1b1a1b] rounded-t-[32px] md:rounded-t-[48px]" />
      </div>

      {/* Footer content */}
      <div className="bg-[#1b1a1b] text-white">
        <div className="container mx-auto px-6 md:px-8 pt-8 pb-6">
          {/* Logo */}
          <div className="mb-10">
            <Image src="/logo/White_SS.png" alt="Superscore" width={130} height={34} className="h-7 w-auto" />
          </div>
          ...
          <div className="grid grid-cols-2 md:grid-cols-4 gap-8 md:gap-12 mb-12">
            ...
            {/* Topluluk */}
            <div>
              <h4 className="text-[#c0bec2] text-base font-medium mb-5">Topluluk</h4>
              <ul className="space-y-3">
                <FooterLink href="#">Güvenilir Yorumlar</FooterLink>
            ...
            {/* İşletmeler */}
            <div>
              <h4 className="text-[#c0bec2] text-base font-medium mb-5">İşletmeler</h4>
              <ul className="space-y-3">
                <FooterLink href="/kayit?tab=brand">Superscore İşletme</FooterLink>
                <FooterLink href="#">Ürünler</FooterLink>
                <FooterLink href="#">Planlar ve Fiyatlar</FooterLink>
                <FooterLink href="/giris">İşletme Girişi</FooterLink>
                <FooterLink href="#">İşletme Blogu</FooterLink>
              </ul>
            </div>

            {/* Sosyal Medya */}
            <div>
              <h4 className="text-[#c0bec2] text-base font-medium mb-5">Bizi Takip Edin</h4>
...
function FooterLink({ href, children }: { href: string; children: React.ReactNode }) {
  return (
    <li>
      <Link href={href} className="text-sm text-white hover:text-[#c0bec2] transition-colors">
        {children}
      </Link>
    </li>
  );
